...
(function($wnd, $doc){
  ...
  var badBrowser = 'Unable to load Super Dev Mode of "foodonwheels" because\n';
  ...
  $wnd.__gwt_activeModules['foodonwheels'] = {
 ...
 * "/foodonwheels.nocache.js" is the one that loaded us. Normally this happens
...
function computeScriptBase() {
  ...
  $wnd.__gwt_activeModules['foodonwheels'].superdevmode = true;

  var expectedSuffix = '/foodonwheels.nocache.js';
  ...
  $wnd.alert('Unable to load Super Dev Mode version of ' + foodonwheels + ".");
}
;
  ...
  var devModeHookKey = '__gwtDevModeHook:foodonwheels';
  var devModeSessionKey = '__gwtDevModeSession:foodonwheels';

  // Compute some codeserver urls so as the user does not need bookmarklets
  var hostName = $wnd.location.hostname;
  var serverUrl = 'http://' + hostName + ':9876';
  var nocacheUrl = serverUrl + '/foodonwheels/foodonwheels.nocache.js';
  ...
  $wnd.__gwt_activeModules['foodonwheels'].canRedirect = true;
  $wnd.__gwt_activeModules['foodonwheels'].superdevmode = true;
  ...
  css = (moduleIdx == 1 ? css : '') +
    ".gwt-DevModeModule-" + moduleIdx + ".gwt-DevModeCompiling div:before{" +
      "content:'COMPILING foodonwheels';" +
      "font-size:24px;" +
      "color:#d2d9ee;" +
    "}";
  ...
  $wnd[compileFunction] = function() {
    ...
    compileScript.src = serverUrl +
      '/recompile/foodonwheels?user.agent=' + ua + '&_callback=' + callback;
